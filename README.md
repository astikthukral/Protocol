...
```
                         AHB Clock Domain — 125 MHz (8 ns period)
  ┌──────────────────────────────────────────────────────────────────────┐
  │                                                                      │
  │  ┌──────────────┐  HBUSREQ[0]  ┌─────────────────┐                 │
  │  │   Master 0   ├─────────────►│                 │                 │
  │  │  Priority: 2 │◄─────────────┤                 │                 │
  │  │  (Highest)   │  HGRANT[0]   │                 │  HMASTER[1:0]   │
  │  └──────┬───────┘              │    A R B I T E R│─────────────────┼──►┐
  │         │                      │                 │                 │   │
  │  ┌──────────────┐  HBUSREQ[1]  │  Round-Robin    │                 │   │
  │  │   Master 1   ├─────────────►│  + Priority     │                 │   │
  │  │  Priority: 1 │◄─────────────┤                 │                 │   │
  │  │  (Mid)       │  HGRANT[1]   │  125 MHz        │                 │   │
  │  └──────┬───────┘              └─────────────────┘                 │   │
  │         │                                                           │   │
  │  ┌──────────────┐  HBUSREQ[2]                                      │   │
  │  │   Master 2   ├──────────────────────────────────────────────┐   │   │
  ...
  │  └──────┬───────┘                                          │   │   │   │
  │         │                                                  │   │   │   │
  │         │   HADDR / HWDATA / HTRANS / HWRITE / HSIZE      │   │   │   │
  │         └──────────────────────────────────────────────►  │   │   │   │
  │                                                         ┌──┴───┴───┴──┐│
  │                                                         │     MUX     ││
  │                                                         │  (selects   ││
  ...
  │                                                                        │
  │  HRDATA / HREADY / HRESP ◄────────────────────────────────────────────┘
  │  (broadcast back to all masters; only current owner acts on it)
  └──────────────────────────────────────────────────────────────────────┘
```
